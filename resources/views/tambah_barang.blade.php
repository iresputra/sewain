    	...
    	<div class="row">
            ...
            @endif  
                    ...
                    <div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="register-form" method="POST" enctype="multipart/form-data"   action="prosestambah"  role="form" style="display: block;">
                                    {{ csrf_field() }}
                                ...
                                @endif
                                    ...
                                    <input name="kuantitas_barang" value="{{ old('kuantitas_barang') }}" type="number" min="1" value="1" class="form-control" id="exampleInputPassword1" placeholder="Masukan Jumlah Barang" required> 
                        ...
                        <div class="form-group{{ $errors->has('harga_barang') ? ' has-error' : '' }}">
                                    ...
                                    <input name="harga_barang" value="{{ old('harga_barang') }}" type="number" min="10000" max="10000000" class="form-control" id="exampleInputPassword1" placeholder="Masukan Harga Barang" required> 
                    ...
                    <textarea name="deskripsi_barang" value="{{ old('deskripsi_barang') }}"class="form-control" id="exampleTextarea" rows="6" required></textarea>
